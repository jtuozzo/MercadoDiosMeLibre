...
if(!isset($_POST['enviar']))
     {require(__DIR__ . '/../resources/views/me_olvide_vista.php');
      exit;
     }
...
if($user->nuevaClave($email))
     {// Se pudo cambiar la clave y enviar la clave, o el mail no está registrado.
      $mensaje.="<div class='mensaje bien'>Si tenés cuenta, se envió un mail a <em>$email</em> con la nueva clave.</div>";
     }
else
     {// No se pudo eviar la clave, aviso que pruebe en un rato.
      $mensaje.="<div class='mensaje mal'>No se pudo cambiar la clave, intentá más tarde.</div>";
     }
require(__DIR__ . '/../resources/views/me_olvide_vista.php');
